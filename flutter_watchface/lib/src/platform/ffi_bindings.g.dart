...
/// Auto-generated bindings for Pebble watchface C API
class WatchfaceNativeBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
  _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  WatchfaceNativeBindings(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  WatchfaceNativeBindings.fromLookup(
    ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup,
  ) : _lookup = lookup;

  /// Get the display specifications from the firmware
  /// Returns: Display specs structure
  WatchfaceDisplaySpecs watchface_get_display_specs() {
    return _watchface_get_display_specs();
  }

  late final _watchface_get_display_specsPtr =
      _lookup<ffi.NativeFunction<WatchfaceDisplaySpecs Function()>>(
        'watchface_get_display_specs',
      );
  late final _watchface_get_display_specs = _watchface_get_display_specsPtr
      .asFunction<WatchfaceDisplaySpecs Function()>();

  /// Send a rendered frame from Flutter to the firmware
  /// @param frame: Pointer to frame data
  /// @return: 0 on success, negative on error
  int watchface_send_frame(ffi.Pointer<WatchfaceFrameData> frame) {
    return _watchface_send_frame(frame);
  }

  late final _watchface_send_framePtr =
      _lookup<
        ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<WatchfaceFrameData>)>
      >('watchface_send_frame');
  late final _watchface_send_frame = _watchface_send_framePtr
      .asFunction<int Function(ffi.Pointer<WatchfaceFrameData>)>();

  /// Initialize the Flutter watchface runtime
  /// @return: 0 on success, negative on error
  int watchface_initialize() {
    return _watchface_initialize();
  }

  late final _watchface_initializePtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function()>>('watchface_initialize');
  late final _watchface_initialize = _watchface_initializePtr
      .asFunction<int Function()>();

  /// Shutdown the Flutter watchface runtime
  void watchface_shutdown() {
    return _watchface_shutdown();
  }

  late final _watchface_shutdownPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('watchface_shutdown');
  late final _watchface_shutdown = _watchface_shutdownPtr
  ...
  void watchface_register_callbacks(
    ...
    return _watchface_register_callbacks(
      on_time_tick,
      on_button_event,
      on_render_request,
      on_activated,
  ...
  late final _watchface_register_callbacksPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            watchface_time_tick_callback,
            watchface_button_event_callback,
            watchface_render_request_callback,
            watchface_activated_callback,
            watchface_deactivated_callback,
          )
        >
      >('watchface_register_callbacks');
  late final _watchface_register_callbacks = _watchface_register_callbacksPtr
      .asFunction<
        void Function(
          watchface_time_tick_callback,
          watchface_button_event_callback,
  ...
  void watchface_trigger_time_tick(int timestamp_ms) {
    return _watchface_trigger_time_tick(timestamp_ms);
  }

  late final _watchface_trigger_time_tickPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
        'watchface_trigger_time_tick',
      );
  late final _watchface_trigger_time_tick = _watchface_trigger_time_tickPtr
      .asFunction<void Function(int)>();

  /// Trigger a button event (called by firmware button handler)
  void watchface_trigger_button_event(int button_id, int event_type) {
    return _watchface_trigger_button_event(button_id, event_type);
  }

  late final _watchface_trigger_button_eventPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Uint8, ffi.Uint8)>>(
        'watchface_trigger_button_event',
      );
  late final _watchface_trigger_button_event =
      _watchface_trigger_button_eventPtr.asFunction<void Function(int, int)>();

  /// Request a render from the Flutter watchface
  void watchface_trigger_render_request() {
    return _watchface_trigger_render_request();
  }

  late final _watchface_trigger_render_requestPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>(
        'watchface_trigger_render_request',
      );
  late final _watchface_trigger_render_request =
      _watchface_trigger_render_requestPtr.asFunction<void Function()>();
}
...
final class WatchfaceDisplaySpecs extends ffi.Struct {
  @ffi.Int32()
  external int width;
  ...
  /// 1 for monochrome, 8 for color
  @ffi.Int32()
  external int color_depth;

  /// -1 if not available
  @ffi.Int32()
  external int dpi;

  /// true for color displays
  @ffi.Bool()
  external bool is_color;
}

/// Frame data containing rendered pixels from Flutter
final class WatchfaceFrameData extends ffi.Struct {
  external ffi.Pointer<ffi.Uint8> pixels;

  @ffi.Size()
  external int pixels_length;
...
final class WatchfaceTimeData extends ffi.Struct {
...
/// Button event data
final class WatchfaceButtonEvent extends ffi.Struct {
  /// 0=up, 1=select, 2=down, 3=back
  @ffi.Uint8()
  external int button_id;

  /// 0=click, 1=long_click, 2=hold, 3=release
  @ffi.Uint8()
  external int event_type;
}

typedef watchface_time_tick_callbackFunction =
    ffi.Void Function(ffi.Pointer<WatchfaceTimeData> time);
typedef Dartwatchface_time_tick_callbackFunction =
    void Function(ffi.Pointer<WatchfaceTimeData> time);

/// Callback function types that Flutter will implement
typedef watchface_time_tick_callback =
    ffi.Pointer<ffi.NativeFunction<watchface_time_tick_callbackFunction>>;
typedef watchface_button_event_callbackFunction =
    ffi.Void Function(ffi.Pointer<WatchfaceButtonEvent> event);
typedef Dartwatchface_button_event_callbackFunction =
    void Function(ffi.Pointer<WatchfaceButtonEvent> event);
typedef watchface_button_event_callback =
    ffi.Pointer<ffi.NativeFunction<watchface_button_event_callbackFunction>>;
typedef watchface_render_request_callbackFunction = ffi.Void Function();
typedef Dartwatchface_render_request_callbackFunction = void Function();
typedef watchface_render_request_callback =
    ffi.Pointer<ffi.NativeFunction<watchface_render_request_callbackFunction>>;
typedef watchface_activated_callbackFunction = ffi.Void Function();
typedef Dartwatchface_activated_callbackFunction = void Function();
typedef watchface_activated_callback =
    ffi.Pointer<ffi.NativeFunction<watchface_activated_callbackFunction>>;
typedef watchface_deactivated_callbackFunction = ffi.Void Function();
typedef Dartwatchface_deactivated_callbackFunction = void Function();
typedef watchface_deactivated_callback =
