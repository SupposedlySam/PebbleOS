...
#define FLASH_REGION_DEF(MACRO, arg)                                                        \
  ...
  MACRO(FIRMWARE_SLOT_0,         0x0300000 /*  3072K */, arg) /* 0x12020000 - 0x1231FFFF */ \
  ...
  MACRO(FILESYSTEM,              0x0690000 /*  6720K */, arg) /* 0x12AB0000 - 0x1313FFFF */ \
  MACRO(DART_MODULE,             0x0E00000 /* 14336K */, arg) /* 0x13140000 - 0x13F3FFFF (XIP-exec AOT) */ \
...
#define FLASH_REGION_DART_MODULE_BEGIN FLASH_REGION_START_ADDR(DART_MODULE)
#define FLASH_REGION_DART_MODULE_END FLASH_REGION_END_ADDR(DART_MODULE)
